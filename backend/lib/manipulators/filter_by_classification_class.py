"""
filter_by_classification_class — 특정 Head 의 특정 Class 포함/제외 필터 (STUB).
...
class FilterByClassificationClass(UnitManipulator):
    """DB seed name: "filter_by_classification_class"."""

    @property
    def name(self) -> str:
        return "filter_by_classification_class"
    ...
    def transform_annotation(
        ...
        raise NotImplementedError(
            "filter_by_classification_class 는 아직 구현되지 않았습니다 (stub)."
        )
