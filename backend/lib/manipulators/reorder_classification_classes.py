"""
reorder_classification_classes — 특정 Head 내 Class 순서 변경 manipulator (STUB).
...
class ReorderClassificationClasses(UnitManipulator):
    """DB seed name: "reorder_classification_classes"."""

    @property
    def name(self) -> str:
        return "reorder_classification_classes"
    ...
    def transform_annotation(
        ...
        raise NotImplementedError(
            "reorder_classification_classes 는 아직 구현되지 않았습니다 (stub)."
        )
