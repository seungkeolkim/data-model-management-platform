...
cls_demote_head_to_single_label / cls_sample_n_images / **cls_rotate_image** / **cls_add_head** / **cls_set_head_labels_for_all_images** 실구현을 완료했다.
이미지 변형 1종 (cls_crop_image) 만 stub + seed + 팔레트 까지 노출한 상태 (§5),
...
### 2-4. MANIPULATOR_REGISTRY — 자동 발견 (27종: det 12 실구현 + cls 12 실구현 + cls 3 stub)
...
13. **이미지 변형 노드 1종 — stub + seed + 팔레트 노출 완료, 실구현 대기** (핸드오프 021 §1-2)
...
14. **잔여 Classification 필터 stub 2종**
