...
> **작업지시서 v7.8** | DatasetGroup.head_schema SSOT 단일 원칙 강제 — Group 내 Dataset 모두 동일 schema, 예외 없음
> 기준일: 2026-04-22
...
16. **Automation 실구현** — 정책 확정 대기 (lineage 조정 + minor 버전 증가 규약). 자동화 모델 초안 + 도구 검토는 `docs_for_claude/023-automation-mockup-tech-note.md` 참조.
